...
export const strings = {
  ...
  settings: {
    ...
    addEquipmentPlaceholder: 'Add your own equipment…',
    addEquipment: 'Add',
    equipmentExists: 'You already have that equipment.',
    equipmentAdded: (name: string) => `Added ${name}`,
    removeEquipmentLabel: (name: string) => `Remove ${name}`,
